# train 명령어
# python main.py --mode train --data IEMOCAP --split_fold 10 --random_seed 46 --epoch 500 --gpu 0

# test 명령어
# python main.py --mode test --data IEMOCAP --test_path {모델파일있는폴더경로} --random_seed 46
